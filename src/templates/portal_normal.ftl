...
<html class="${root_css_class}" dir="<@liferay.language key="lang.dir" />" lang="${w3c_language_id}">
	...
	<#elseif (getterUtil.getString(theme_settings['color_schemes']!"", "") == "BLUEDARKCONFIA")>
		<#assign css_class = css_class +" bluedarkconfia" />
	</#if>
					...
					<div class="">
						...
						<footer class="footer-bs">
							<div class="row max-width">
								<div class="col-md-4 footer-brand center-center" style="padding: 0px !important; margin-bottom: 10px;">
									<img class="footer-confia-logo" src="${themeDisplay.getPathThemeRoot()}/images/logo-confia.svg" alt="Afiliado" title="Afiliado">
								</div>
								<div class="col-md-4 text-center center-center">
									<p class="font-p text-white">
										CONFÍA VIRTUAL Copyright <br>
										Derechos Reservados - El Salvador
									</p>
								</div>
								<div class="col-md-4 text-center center-center">
									<button type="button" class="white-button btn btn-lg btn-block d-flex">
										<div class="text-button-div" style="padding: 0px 0px 0px 10px !important;">
